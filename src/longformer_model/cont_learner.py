...
fullset = pd.read_csv('gs://fake_news_corpus11/lonformer_cred_cls/data/cat_feat_v1_5.csv', sep='\t', nrows=1000)
...
#         'groundTruth': './src/longformer_model/models/base_model',
#         'increModel': './src/longformer_model/models/',
#     }
