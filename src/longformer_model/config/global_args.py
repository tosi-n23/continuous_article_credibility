...
global_args = {
    ...
    "max_seq_length": 512, #128, 512 256
    "train_batch_size": 28, #8 16
    "gradient_accumulation_steps": 16, #8 16
    "eval_batch_size": 16, #8
    "num_train_epochs": 8, #8, 3
    "weight_decay": 0.1,
    "learning_rate": 5e-5, #1e-4 1e-5 1e-8 3e-5 0.01 4e-5 1e-3 3e-5
    "adam_epsilon": 1e-8,
    "warmup_ratio": 0.06,
    "warmup_steps": 0,
    "max_grad_norm": 1.0,
    ...
    "silent": False,
    "wandb_project": "article-credibility-transformers",
    "wandb_kwargs": {},
